      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-superficie border border-vora rounded-card p-6 shadow-sm">
          ...
          <button
            ...
            disabled={carregant}
            className="w-full flex items-center justify-center gap-3 border border-vora rounded-lg py-2.5 px-4 text-sm font-medium text-text-principal hover:bg-fons transition-colors mb-4 disabled:opacity-50"
          >
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-text-secundari">o</span>
            <div className="flex-1 h-px bg-vora" />
          </div>
